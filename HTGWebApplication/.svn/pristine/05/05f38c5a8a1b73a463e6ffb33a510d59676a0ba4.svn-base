...
/**
 * Document: UpdateStaffByAdminBean
 * Version: Jan 20 2017 
 * Author     : Marufa Chowdhury, Rachel Bautista, Mamadou Diallo, Tuan L. Truong, Rodney Vencio
 * Description: java bean class hanlding the interaction with the database through the call of stored procedure
 * to return the staff information to the servlet controller
 * 
 */
//@Stateful
//@LocalBean
        ...
        try
        {
            ...
            try(Connection conn = getConnection())
            {
                ...
                while(rs.next())
                {
                    ...
                    this.jobStatus = rs.getString(11);
