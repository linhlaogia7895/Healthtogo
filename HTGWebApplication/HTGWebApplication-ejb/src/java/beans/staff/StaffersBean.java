...
public class StaffersBean{
     ...
     * @return  list of patient to create invoice
     */
        ...
        try
        {
            ...
            try(Connection conn = getConnection())
            {
                ...
                while(rs.next())
                {
                    ...
                    resulttable+=("<td>" +rs.getString(5)+ "</td>");
                     //resulttable+=("<td>" +rs.getString(6)+ "</td>");
                     resulttable+=("<td><a href='createInvoice.jsp?patientID="+rs.getInt(1) +"'>Create New Invoice</a></td>");
                     resulttable+=("</tr></tbody>"); 
                }
     ...
     * @param username user who does function
     * @param patientId patient id
     * @param subTotal sub total
     * @param taxRate tax rate
     * @param taxableAmount tax amount
     * @param total total
     * @param billAddress bill address
     * @param description description
     * @return true if successfully, otherwise false
     * @throws SQLException 
     */

    public boolean createNewInvoice(String username, String patientId, String subTotal, String taxRate, String taxableAmount, String total, String billAddress, String description) throws SQLException {
        boolean created=false;
        ...
        try {
            ...
            try (Connection conn = getConnection()) {
                ...
                ps.setString(5,taxableAmount);
                ps.setString(6,total);
                ps.setString(7,billAddress);
