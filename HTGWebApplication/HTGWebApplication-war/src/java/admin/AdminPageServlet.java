...
public class AdminPageServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
       ...
       // String keyParameter = request.getParameter("keyEncrypt");
        String url="/admin.jsp";;
//        if(CreateSecurityHelper.decrypt(keyParameter).equals("input")){
//            url="/admin.jsp";            
//        }else{
...
//        }
            ...
            try
            {
                ...
                {   
                   ...
                   // double staffSalary = Double.parseDouble(salary);
                    if(newStaff.createStaffACcount(userName, username, password, "staff",lockedStatus, firstName, lastName, email,address, homePhone, cellPhone, sqlBirthDate, sqlDateOfHire, gender, jobStatus, accountStatus))
                    {
        ...
        else if(submitResetStaff != null)
        {
            ...
            adminbean.resetPasswordByUserAndAdmin(username, Integer.parseInt(request.getParameter("theStaffID")), newPassword );
