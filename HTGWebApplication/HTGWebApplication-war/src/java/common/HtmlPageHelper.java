 ...
 */
public final class HtmlPageHelper {

    private static HtmlPageHelper obj = null;
    public static synchronized HtmlPageHelper getInstance(){
	if(obj==null){
	    obj=new HtmlPageHelper();
	    return obj;
	}else{
	    return obj;
	}
     ...
     */
    public final StringBuffer sendMessage(String message){
		...
		.append("<div class='modal-body'>")
                        .append("<h5><span id='message-text'>")
			    .append(message)
			.append("</span></h5>")
                        .append("</div>")
                    .append("</div>")
    ...
    public final void setNavBarElements(String userType, HttpServletRequest request){
