...
/**
 * Document   : VolunteerFileUploadServlet.java
 * Version    : March 1, 2017
 * Author     : Marufa Chowdhury, Rachel Bautista, Mamadou Diallo, Tuan L. Truong, Rodney Vencio
 * Description: Servlet for uploading resumes
 */
public class VolunteerFileUploadServlet extends HttpServlet {
...
//        System.out.println("content-disposition header= "+contentDisp);
	...
	try {
	    ...
	    Logger.getLogger(VolunteerFileUploadServlet.class.getName()).log(Level.SEVERE, null, ex);
