...
/**
 * Document   : InternFileUploadServlet.java
 * Version    : March 4, 2017
 * Author     : Marufa Chowdhury, Rachel Bautista, Mamadou Diallo, Tuan L. Truong, Rodney Vencio
 * Description: Servlet for uploading resumes
 */
public class InternFileUploadServlet extends HttpServlet {
...
//        System.out.println("content-disposition header= "+contentDisp);
	...
	try {
	    ...
	    Logger.getLogger(InternFileUploadServlet.class.getName()).log(Level.SEVERE, null, ex);
