...
public class generatePdf extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if(geneInvoice != null)
        {
            ...
            getServletContext().getRequestDispatcher("/pdf.jsp?file="+pdfFilename).forward(request, response);
        }
...
public GenerateInvoice(String patientId, String invoiceId, String subTotal, String total, String address, String description, String dateInvoice)
{
 ...
 public void createPDF (String pdfFilename){
  ...
  try {
   String path = "C:\\Users\\696645\\Documents\\NetBeansProjects\\HTGWebApplication\\HTGWebApplication-war\\web\\pdfFile\\"+pdfFilename+".pdf";
...
//  }
 ...
 private void generateHeader(Document doc, PdfContentByte cb)  {
  ...
  try {
   ...
   createHeadings(cb,200,735,"140 Castlebrook Rise NE");
   createHeadings(cb,200,720,"Calgary, AB, T3J 1P1");
   createHeadings(cb,200,705,"(403)-998-9902");
