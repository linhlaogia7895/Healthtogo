<%-- 
    Document   : changeSecurityQuestion.jsp
    Created on : Jan 26, 2017, 7:33:49 PM
    Author     : Marufa Chowdhury, Rachel Bautista, Mamadou Diallo, Tuan L. Truong, Rodney Vencio
    Description: Form for changing security question
--%>
...
<html>
	...
	<!--CDNs-->
	<c:import url="WEB-INF/jspf/patient/change-security-question/cdn-change-security-question.jspf"></c:import>
    ...
    <body data-spy="scroll" data-target=".navbar" data-offset="50">
		...
		<!--form for changing security question-->
		<c:import url="WEB-INF/jspf/patient/change-security-question/form-change-security-question.jspf"></c:import>
