<%-- 
    Document   : patientEditProfileWhenSignUp.jsp
    Created on : Jan 20, 2017, 12:23:01 PM
    Author     : Marufa Chowdhury, Rachel Bautista, Mamadou Diallo, Tuan L. Truong, Rodney Vencio
    Description: JSP for editing patient profile on sign up
--%>
...
<html>
	...
	<!--CDNs-->
	<c:import url="WEB-INF/jspf/patient/patient-profile-edit/cdn-patient-profile-edit-sign-up.jspf"></c:import>
    ...
    <body data-spy="scroll" data-target=".navbar" data-offset="50">
	    ...
	    <!--personal details-->
	    <c:import url="WEB-INF/jspf/patient/patient-profile-edit/personal-details.jspf"></c:import>
	    <!--end of personal details definitions-->
