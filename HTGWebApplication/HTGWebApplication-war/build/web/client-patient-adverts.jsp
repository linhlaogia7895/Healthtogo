...
<html>
	...
	<link href="https://fonts.googleapis.com/icon?family=Material+Icons" rel="stylesheet">
        ...
        <script src="_js/main/advertisements-script.js" type="text/javascript"></script>
        ...
        <script src="_js/angular/advertisements-controller.js" type="text/javascript"></script>
        <link rel="stylesheet" type="text/css" media="screen" href="_css/common/common.css">
        <link rel="stylesheet" type="text/css" media="screen" href="_css/main/advertisements-style.css">
    </head>
        ...
        <div class="page" ng-app="mainApp">
            ...
            <div class="main-body w3-container container-fluid">
                ...
                <nav class="w3-sidenav w3-black">
                    <a class="w3-padding-16" href="#"><i class="news-section-icon fa fa-newspaper-o"></i></a> 
                    <a class="w3-padding-16" href="#"><i><img class="promos-section-icon" src="_res/main/images/adds-icon.png" alt="Adverts icon"></i></a> 
                    <a class="w3-padding-16" href="#"><i class="careers-section-icon fa fa-briefcase"></i></a> 
                    <a class="w3-padding-16" href="#"><i><img class="interns-section-icon" src="_res/main/images/intern2-icon.png" alt="Interns icon"></i></a> 
                    <a class="w3-padding-16" href="#"><i><img class="volunteers-section-icon" src="_res/main/images/volunteer-icon.png" alt="Volunteers icon"></i></a> 
                </nav>
                ...
                <div style="margin-left:70px">
                    ...
                    <div id="news-table" class="table-bodies news-section-body container w3-container container-fluid" ng-controller="newsSectionController" style="max-width: 90%">
                        ...
                        <div ng-repeat="n in news | orderBy:'-date':true | filter:searchNews" class="w3-accordion w3-light-grey">
                            <button id="tips-btn" ng-click="manageNewsAccordion(n.id)" class="w3-btn-block w3-left-align"><span id="tips-btn-text">{{n.title}} <span ng-model="dates" class="pull-right">Date: {{n.date}}</span></span></button>
				...
				<h5>Source: <a href="{{n.href}}" target='_blank'>{{n.hrefText}}</a></h5>
                                <div id="tips-content" ng-bind-html='n.content'></div> <!-- ng-bind-html requires the ng-sanitize CDN -->
                            </div>
                        </div>
                        <br>
                    </div>
		    ...
		    <!--promos section - style using W#.CSS - has angular component -->
                    <div id="promos-table" class="table-bodies news-section-body container w3-container container-fluid" ng-controller="promosSectionController" style="max-width: 90%">
                        ...
                        <div ng-repeat="p in promos | orderBy:'-date':true | filter:searchPromos" class="w3-accordion w3-light-grey">
                            <button id="ads-btn" ng-click="manageNewsAccordion(p.id)" class="w3-btn-block w3-left-align"><span id="ads-btn-text">{{p.title}} <span ng-model="dates" class="pull-right">End Date: {{p.date}}</span></span></button>
                            <div id='{{y.id}}' class="w3-accordion-content w3-container">
                                <h3 style="text-align: center;">{{p.title}}</h3>
				<h5>Posting date: {{y.datePosted}}</h5>
				<h5>Closing date: {{y.dateExpired}}</h5>
                                <div id="tips-content" ng-bind-html='p.content'></div> <!-- ng-bind-html requires the ng-sanitize CDN -->
				<button>Apply</button>
                            </div>
                        </div>
                        <br>
			...
			<!--the table-->
				    ...
				    <td>
                            ...
                            <tbody>
                                <tr ng-repeat="w in works | orderBy:sortType:sortReverse | filter:searchFood">
                                    <td><a href="{{w.href}}">{{w.positionID}}</a></td>
                                    <td><a href="{{w.href}}">{{w.title}}</a></td>
                                    <td>{{w.category}}</td>
                        ...
                        <form>
                            <div class="form-group">
                                <div class="input-group input-group-lg">
                                    ...
                                    <input type="search" name="search" class="form-control" placeholder="Search internships" ng-model="searchInternships">
                                </div>
